...
namespace Task1.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public MainViewModel()
        {
            ...
            ChangeStatusCommand = new RelayCommand(p => ChangeStatus(p));

            ExitCommand = new RelayCommand(_ => Application.Current.Shutdown());

            AboutCommand = new RelayCommand(_ => MessageBox.Show(
                "Task Manager v2.0\nDataBinding · ObservableCollection · Templates",
        ...
        {
            AddToCollection(new TaskItem
            {
                Title = "Разработать главное меню",
                Priority = "Высокий",
                Status = "В работе",
                Description = "Создать навигационное меню",
            ...
            AddToCollection(new TaskItem
            {
                ...
                Priority = "Средний",
                Status = "В работе",
                Description = "Протестировать сценарии использования",
            ...
            AddToCollection(new TaskItem
            {
                ...
                Priority = "Высокий",
                Status = "Выполнено",
                Description = "Ошибка при пустом пароле",
            ...
            AddToCollection(new TaskItem
            {
                ...
                Priority = "Низкий",
                Status = "Выполнено",
                Description = "Обновить NuGet-пакеты",
        ...
        private void ApplyFilter()
        {
            ...
            {
                bool statusMatch = FilterStatus == "Все"
        ...
        private void ChangeStatus(object? parameter)
        {
            ...
            {
                task.Status = task.NextStatus;
                ApplyFilter();
                StatusMessage = $"Статус «{task.Title}» → «{task.Status}».";
            }
        }
